...
describe("setupIntervalsBlocks", () => {
    ...
    describe("Setup", () => {
        ...
        it("Value blocks updateParameter returns block value", () => {
            ...
            expect(
                createdBlocks.currentinterval.updateParameter(
                    logo,
                    turtleIndex,
                    "blkCurrentInterval"
                )
            ...
            expect(
                createdBlocks.modelength.updateParameter(logo, turtleIndex, "blkModeLength")
            ).toBe(7);
            expect(
                createdBlocks.currentmode.updateParameter(logo, turtleIndex, "blkCurrentMode")
            ).toBe("minor");
            expect(createdBlocks.key.updateParameter(logo, turtleIndex, "blkKey")).toBe("G");
        });
    });

    describe("IntervalNumberBlock", () => {
        it("returns interval number", () => {
            const blk = "blk1";
        ...
        it("pushes to statusFields when inStatusMatrix", () => {
    ...
    describe("ModeLengthBlock", () => {
        it("returns mode length", () => {
            const blk = "blk4";
            activity.blocks.blockList[blk] = { connections: [null] };
    ...
    describe("SemitoneIntervalBlock", () => {
        it("sets interval and returns child block", () => {
        ...
        it("returns undefined when child block is missing", () => {
            const result = createdBlocks.semitoneinterval.flow(
                [5, undefined],
                logo,
                turtleIndex,
    ...
    describe("DoublyBlock", () => {
        it("returns 0 and shows error on null connection", () => {
        ...
        it("adds 1 for augmented intervalname", () => {
        ...
        it("subtracts 1 for diminished intervalname", () => {
            activity.blocks.blockList.blk1 = { connections: [null, "conn1"] };
        ...
        it("returns 0 for trailing doubly chain", () => {
            activity.blocks.blockList.blk1 = { connections: [null, "conn1"] };
    ...
    describe("ChordIntervalBlock", () => {
        it("sets intervals and returns child block", () => {
            global.CHORDNAMES = ["major"];
            global.CHORDVALUES = [
                [
                    [0, 0],
        ...
        it("falls back to default chord", () => {
            global.CHORDNAMES = ["major"];
            global.CHORDVALUES = [
                [
                    [0, 4],
    ...
    describe("RatioIntervalBlock", () => {
        it("shows error when input block is missing", () => {
        ...
        it("uses intervalname ratio value", () => {
        ...
        it("falls back when interval name is unknown", () => {
            activity.blocks.blockList.blkRatio = { connections: [null, "conn1"] };
    ...
    describe("SetKey2Block", () => {
        it("constructor handles beginner Japanese help branch", () => {
            createdBlocks = {};
        ...
        it("updates notation inside mode widget", () => {
            const turtle = { singer: { keySignature: "" } };
            activity.turtles.ithTurtle = jest.fn(() => turtle);
    ...
    describe("DefineModeBlock", () => {
        it("sets mode and returns child block", () => {
    ...
    describe("MeasureIntervalSemitonesBlock", () => {
        it("errors when no input block", () => {
            activity.blocks.blockList.blkMeasure = { connections: [null, null] };
            const result = createdBlocks.measureintervalsemitones.arg(
                logo,
                turtleIndex,
                "blkMeasure"
            );
        ...
        it("returns measured semitone distance", () => {
        ...
        it("shows error when two pitches are missing", () => {
            activity.blocks.blockList.blkMeasure = { connections: [null, "child"] };
            logo.runFromBlockNow = jest.fn();
    ...
    describe("MeasureIntervalScalarBlock", () => {
        it("errors when no input block", () => {
        ...
        it("returns measured scalar distance", () => {
    ...
    describe("ArpeggioBlock", () => {
        ...
        it("queues blocks and stores disconnected connections", () => {
            ...
            activity.blocks.blockList.child2 = {
                name: "note",
                connections: ["child1", null, null]
            };
        ...
        it("reuses another turtle connectionStore", () => {
        ...
        it("handles hidden block disconnection path", () => {
            activity.blocks.blockList.blkArp = { name: "arpeggio", connections: [null] };
            activity.blocks.blockList.child1 = {
                name: "note",
